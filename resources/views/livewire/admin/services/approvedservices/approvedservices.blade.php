<div>
    ...
    <button class="btn btn-success me-md-2" data-bs-toggle="modal" data-bs-target="#rtpiModal" id="rtpiModalToggler" style="display:none">Add</button>
    <div  wire:ignore.self class="modal fade" id="rtpiModal" tabindex="-1" role="dialog" aria-labelledby="rtpiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="rtpiModalLabel">Ready to Pick Up Service</h5>
                    <button type="button" class="close text-light" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="save_rtpi_availed_service(@if($service_availed['availed_services']) {{$service_availed['availed_services']->id}} @endif,'rtpiModalToggler')">
                    <div class="modal-body bg-white text-black">
                        <p class="text-success text-center">
                            Are you sure you want to make this Ready to Pick Up Service?
                        </p>
                    </div>
                    @if($error)
                    <div class="modal-body bg-white text-black">
                    ...
                    <div class="modal-footer bg-white text-black">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-success" >Ready to Pick Up Service</button>
                    </div>
                </form>
            </div>
        </div>
