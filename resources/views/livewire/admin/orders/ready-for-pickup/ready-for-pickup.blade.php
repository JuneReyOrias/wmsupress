                ...
                <div class="col-md-15"> 
                    <div class="card">
                        <div class="card-header bg-dark text-white">
                            <h3 class="text-center">Ready for pick up Orders</h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <button class="btn btn-warning btn-sm" wire:click="view_order({{$value->id}},'confirmModalToggler')">
                                                    Return to Confirmed Order
                                                </button>
            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="save_confirm_order(@if($order_details['customer_order']){{$order_details['customer_order']->id}}@endif,'confirmModalToggler')">
                    ...
                    <div class="modal-footer bg-white">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-warning" >Return to Confirmed Order</button>
                    </div>
                </form>
            </div>
        </div>
