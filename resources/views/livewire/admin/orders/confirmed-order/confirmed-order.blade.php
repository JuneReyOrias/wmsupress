...
<div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <button class="btn btn-warning btn-sm" wire:click="view_order({{$value->id}},'pendingModalToggler')">
                                                    Return to Pending Order
                                                </button>
                                                <button class="btn btn-success btn-sm" wire:click="view_order({{$value->id}},'rfpuModalToggler')">
    ...
    <div  wire:ignore.self class="modal fade" id="pendingModal" tabindex="-1" role="dialog" aria-labelledby="pendingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="viewModalLabel">Decline Order</h5>
                    <button type="button" class="close text-light" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="save_pending_order(@if($order_details['customer_order']){{$order_details['customer_order']->id}}@endif,'pendingModalToggler')">
                    ...
                    <div class="modal-footer bg-white text-black">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-warning" >Return to Pending Order</button>
                    </div>
                </form>
            </div>
        </div>
    </div> 
    <button class="btn btn-success me-md-2" data-bs-toggle="modal" data-bs-target="#rfpuModal" id="rfpuModalToggler" style="display:none">Add</button>
    <div wire:ignore.self class="modal fade" id="rfpuModal" tabindex="-1" role="dialog" aria-labelledby="rfpuModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="rfpuModalLabel">Ready for Pickup Order</h5>
                    <button type="button" class="close text-light" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form wire:submit.prevent="save_rfpu_order(@if($order_details['customer_order']){{$order_details['customer_order']->id}}@endif,'rfpuModalToggler')">
                    <div class="modal-body bg-white text-black">
                        <p class="text-success text-center">
                            Are you sure you want to make Ready for Pickup Order?
                        </p>
                    </div>
                    <div class="modal-footer bg-white text-black">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-success" >Ready for Pickup Order</button>
                    </div>
                </form>
            </div>
        </div>
