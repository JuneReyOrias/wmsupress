                ...
                <div class="col-md-15"> 
                    <div class="card">
                        <div class="card-header bg-dark text-white">
                            <h3 class="text-center">Declined Orders</h3>
                        </div>
                        <div class="card-body">
    ...
    <div class="modal fade" id="pendingModal" tabindex="-1" role="dialog" aria-labelledby="pendingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form wire:submit.prevent="save_pending_order(@if($order_details['customer_order']){{$order_details['customer_order']->id}}@endif,'declineModalToggler')">
